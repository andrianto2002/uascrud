                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(NOTELPON, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 156, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        .addGap(60, 60, 60)
...
try {
            String sql = "INSERT INTO kry VALUES ('"+ID.getText()+"','"+NAMA.getText()+"','"+jComboBox1.getSelectedItem()+"','"+ALAMAT.getText()+"','"+NOTELPON.getText()+"')";
...
try {
            String sql ="UPDATE kry SET nama = '"+ID.getText()+"', NAMA = '"+NAMA.getText()+"', JABATAN = '"+jComboBox1.getSelectedItem()+"',ALAMAT= '"+ALAMAT.getText()+"',NOTELPON= '"+NOTELPON.getText()+"' WHERE NAMA = '"+NAMA.getText()+"'";
            java.sql.Connection conn=(Connection)config.configDB();
            java.sql.PreparedStatement pst=conn.prepareStatement(sql);
            pst.execute();
